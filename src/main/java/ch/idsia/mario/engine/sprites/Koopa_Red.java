...
public class Koopa_Red extends Koopa {
	// can die by fireball and be stomped --> drops a green shell

	private final static int yPicPreset = 0;
	private static final SpriteKind kind = SpriteKind.KIND_RED_KOOPA;
	
	public Koopa_Red(LevelScene alreadyCopied, Koopa_Red toCopy) {
		super(alreadyCopied, toCopy);
		height = 24;
		yPic = yPicPreset;
	}

	public Koopa_Red(LevelScene world, int x, int y, int dir, boolean winged, int mapX, int mapY) {
